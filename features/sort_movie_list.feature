...
Scenario: sort movies alphabetically
  ...
  And I should not see "When Harry Met Sally" before "Aladdin"
  And I should not see "Amelie" before "2001: A Space Odyssey"
...
Scenario: sort movies in increasing order of release date
  ...
  And I should not see "The Incredibles" before "Aladdin"
